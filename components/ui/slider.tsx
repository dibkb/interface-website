...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-[#949494] dark:bg-neutral-800">
      <SliderPrimitive.Range className="absolute h-full bg-primary-green dark:bg-neutral-50" />
