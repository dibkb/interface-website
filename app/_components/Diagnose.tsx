...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-lg border-2 border-border bg-white p-3",
        className,
      )}
    >
      {children}
...
export function Diagnose({ className }: { className?: string }) {
...
//   const div7Ref = useRef<HTMLDivElement>(null);
//   return (
//     <section className="h-fit w-full py-20 lg:py-10 px-10 xl:px-20 2xl:px-48">
