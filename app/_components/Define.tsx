...
import Diagnose from "@/public/Features/Diagnose.png";
...
//       ref={ref}
//       className={cn(
//         "z-10 flex size-12 items-center justify-center rounded-xl border-2 border-border bg-white p-3 ",
//         className,
//       )}
//     >
//       {children}
...
{
  /*   <div className="flex size-full flex-row items-stretch justify-between gap-5 max-w-lg"> */
}
{
...
{
  /*       <div ref={div5Ref} className="size-16"></div> */
}
{
  /*     </div> */
}
